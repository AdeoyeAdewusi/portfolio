      ...
      <div className="aboutComp">
        ...
        <div className="aboutComp_ab">
          <p className="aboutComp_abs">
            ...
            frameworks, with experience in building websites that are responsive
            for all screens. Excellent communicator and effective team player .
            I'm a problem solver and a critical thinker with the abilities to
            brainstorm with teammates to proffer solutions to design concepts
